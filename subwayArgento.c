...
/*void *imprimirAccion ( void *data, char *accionIn) {
	...
	// calculo la longitud del array de paso
...
/*   	 strcpy (pthread_data-> pasos_param [ 0 ]. accion , " cortar " );
	...
	strcpy (pthread_data-> pasos_param [2] . ingredientes  [0],"mezclar " );
	strcpy (pthread_data-> pasos_param [3] . accion ,"agregar carne" );
	strcpy (pthread_data-> pasos_param [3] . ingredientes [0],"mezclar " );
	...
	strcpy (pthread_data-> pasos_param [7] . accion, "preparar");
